...
// Cuentas
const response = await fetch('https://raw.githubusercontent.com/Richetti123/WallsBot/master/official_accounts.json')  
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: 'WallsBot ', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
